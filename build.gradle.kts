...
description = "A Result type representing either a success or a failure."
...
//                        url.set("https://www.michael-bull.com")
                ...
                scm {
                    connection.set("scm:git:https://github.com/Jason5lee/resukt")
                    developerConnection.set("scm:git:git@github.com:Jason5Lee/resukt.git")
                    url.set("https://github.com/Jason5Lee/resukt")
                }
